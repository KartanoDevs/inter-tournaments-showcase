#!/bin/bash
# =================================================================
# deploy-4vs4.sh — Script de despliegue para producción (rama 4vs4)
# Uso: bash deploy-4vs4.sh
# =================================================================
...
echo "================================================================="
echo " INTER AUU — Despliegue en Producción (rama 4vs4)"
echo "================================================================="
echo ""
...
# -----------------------------------------------
echo "[1/6] Actualizando código desde el repositorio (rama 4vs4)..."
cd "$APP_DIR"
git pull origin 4vs4
...
echo "================================================================="
echo " DESPLIEGUE COMPLETADO (rama 4vs4)"
